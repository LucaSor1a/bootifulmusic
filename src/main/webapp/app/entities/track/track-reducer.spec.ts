...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './track.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TRACK_LIST actions', async () => {
    ...
    it('dispatches FETCH_TRACK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TRACK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TRACK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TRACK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TRACK actions', async () => {
      const expectedActions = [
        {
