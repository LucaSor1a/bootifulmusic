...
describe('Album e2e test', () => {
  ...
  const albumSample = { name: 'Awesome' };
  ...
  describe('new Album page', () => {
    ...
    it('should create an instance of Album', () => {
      cy.get(`[data-cy="name"]`).type('Soft').should('have.value', 'Soft');

      cy.get(`[data-cy="released"]`).type('2021-12-03').should('have.value', '2021-12-03');
